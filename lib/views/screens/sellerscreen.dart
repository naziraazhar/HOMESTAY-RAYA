...
import 'package:homestayapp/config.dart';
import 'package:homestayapp/models/product.dart';
import 'package:homestayapp/views/screens/detailscreen.dart';
import 'package:homestayapp/views/screens/loginscreen.dart';
import 'package:homestayapp/views/screens/newproductscreen.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
              // isExtended: true,
              backgroundColor: Color.fromARGB(255, 46, 18, 55),
              onPressed: () {
                _gotoNewProduct();
              },
              // isExtended: true,
